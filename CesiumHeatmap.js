...
(function(window){
    ...
    function define_CesiumHeatmap() {
		...
		CesiumHeatmap.create = function(cViewer, bb, options) {
			var instance = new CHInstance(cViewer, bb, options);
			return instance;
		};
...
CHInstance.prototype.geoPointToHeatmapPoint = function(p) {
...
CHInstance.prototype.setWidthAndHeight = function(mbb) {
...
CHInstance.prototype.setWGS84Data = function(min, max, data) {
	if (data && data.length > 0 && min !== null && min !== false && max !== null && max !== false) {
		...
		for (var i = 0; i < data.length; i++) {
			...
			var hp = this.geoPointToHeatmapPoint(gp);
